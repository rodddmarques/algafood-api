...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (4, 'Bar Recreio', 0, 3, utc_timestamp, utc_timestamp);
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('salada tailandesa', 'mix de folhas e ervas', 15, true, 2);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('tailandia express', 'box com a pedida do chefe do dia', 20, true, 2);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('tropeiro mineiro', 'Feijao tropeiro bem servido e guarniçoes', 18, true, 4);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('salada xique', 'tomate cereja com folhas da epoca', 24, true, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Heineken', 'cerveja puro malte', 12, true, 4);
